...
async def main():
    ...
    if mcp_endpoint is not None and "你" not in mcp_endpoint:
        ...
        if validate_mcp_endpoint(mcp_endpoint):
            ...
            logger.bind(tag=TAG).error("mcp Endpoint does not conform to spec")
    ...
    logger.bind(tag=TAG).info(
        "======= The address above is a websocket protocol address, do not open it in a browser ======="
    )
    logger.bind(tag=TAG).info(
        "To test websocket, start the digital-human module and use the browser interactive test"
    )
    logger.bind(tag=TAG).info(
        "=============================================================\n"
    )
...
if __name__ == "__main__":
    try:
        ...
        print("Manual interrupt, terminating.")
