            ...
            try:
                ...
                # 建立SSEClient
                    ...
                    if "API_ACCESS_TOKEN" in self.config:
                        ...
                        self.logger.bind(tag=TAG).warning(f"You are using an old, deprecated config API_ACCESS_TOKEN , please.mcp_server_settings.json in API_ACCESS_TOKEN Set directly on headers , e.g. 'Authorization': 'Bearer API_ACCESS_TOKEN'")
