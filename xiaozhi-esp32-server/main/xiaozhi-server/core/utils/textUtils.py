...
def is_punctuation_or_emoji(char):
    ...
    punctuation_set = {
        ...
        # leaning on the TTS server's _fix_cues repair. Full-width 【】 aren't used for cues -> still stripped.
        "【",
        "】",  # 中文方括号
    }
...
async def get_emotion(conn: "ConnectionHandler", text):
    ...
    try:
        ...
        conn.logger.bind(tag=TAG).warning(f"Failed to send emotion expression, error:{e}")
    return
