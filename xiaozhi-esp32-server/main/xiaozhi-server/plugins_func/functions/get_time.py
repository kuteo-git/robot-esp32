...
def get_lunar(date=None, query=None):
    """
    Used to get the current lunar calendar date, along with the stem-branch cycle, solar term,
    zodiac sign, star sign, bazi, and other almanac information.
    """
    from core.utils.cache.manager import cache_manager, CacheType

    # If a date parameter was provided, use it; otherwise use the current date
    if date:
        try:
    ...
    # Try to get the lunar info from the cache
