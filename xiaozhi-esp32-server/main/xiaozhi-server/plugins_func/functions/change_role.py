...
def change_role(conn: "ConnectionHandler", role: str, role_name: str):
    ...
    if role not in prompts:
        return ActionResponse(
            action=Action.RESPONSE, result="Đổi vai trò thất bại", response="vai trò không hỗ trợ"
        )
    ...
    return ActionResponse(action=Action.RESPONSE, result="Đã đổi vai trò", response=res)
