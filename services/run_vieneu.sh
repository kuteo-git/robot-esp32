...
export VIENEU_BOOST_DB=3.0                         # +3dB (lowered from 3.5 on 2026-07-25: robot speaker still crackled at 3.5, confirmed clean in the raw WAV -> analog/amp headroom issue, not digital clipping). Raise to 3.5-5 for louder, lower to 2.5 if it still crackles
